...
import com.example.speedometer.tflite.Classifier
...
class Camera2BasicFragment : Fragment(),
    ...
    private val mInputSize = 20
    private val mModelPath = "model_20px_10epochs.tflite"
...
//                LOGGER.d("Initializing buffer %d at size %d", i, buffer.capacity())
    ...
    override fun onActivityCreated(savedInstanceState: Bundle?) {
        ...
        classifier = Classifier(activity!!.assets, mModelPath);
    ...
    override fun onRequestPermissionsResult(
        ...
        if (requestCode == REQUEST_CAMERA_PERMISSION) {
            if (grantResults.size != 2 || (grantResults[0] != PackageManager.PERMISSION_GRANTED &&
                ...
                ErrorDialog.newInstance(REQUEST_CAMERA_PERMISSION_MESSAGE)
    ...
    private fun setUpCameraOutputs(width: Int, height: Int) {
        ...
        try {
            for (cameraId in manager.cameraIdList) {
                ...
                // TODO CAMBIAR PARA VOLANTE Y CINTURON
                ...
                // ADDED sensorOrientation = characteristics.get(CameraCharacteristics.SENSOR_ORIENTATION)
            ...
            ErrorDialog.newInstance("ERROR DE LA CAMARA")
                    .show(childFragmentManager, FRAGMENT_DIALOG)
        }
